...
kruskal.condition.subs <- tidy(kruskal.test(substratum.inoculum.3$growth_30days  ~ as.factor( substratum.inoculum.3$condition), data= substratum.inoculum.3 ))
...
test_dunn.subs <- dunn.test(substratum.inoculum.3$growth_30days , as.factor(substratum.inoculum.3$condition),method = 'bonferroni')
...
kruskal.media.subs <- tidy(kruskal.test(substratum.inoculum.3$growth_30days  ~ as.factor( substratum.inoculum.3$substratum), data= substratum.inoculum.3 ))
...
test_dunn.subs <- dunn.test(substratum.inoculum.3$growth_30days , as.factor(substratum.inoculum.3$substratum),method = 'bonferroni')
# test_dunn.media<-flextable::flextable( dunn.test(media.fls.5$average_conidia_per_square_hemocytometer , as.factor(media.fls.5$media),method = 'bonferroni'))
# flextable::save_as_docx(test_dunn.media, path = "nice_table_test_dunn_media.docx")
x.subs <- test_dunn.subs$comparisons
y.subs <- test_dunn.subs$P.adjusted
...
kruskal.pathogen.subs <- tidy(kruskal.test(substratum.inoculum.3$growth_30days  ~ as.factor( substratum.inoculum.3$pathogen), data= substratum.inoculum.3 ))
...
test_dunn.subs <- dunn.test(substratum.inoculum.4$growth_30days , as.factor(substratum.inoculum.4$treatment),method = 'bonferroni')
# test_dunn.media<-flextable::flextable( dunn.test(media.fls.5$average_conidia_per_square_hemocytometer , as.factor(media.fls.5$media),method = 'bonferroni'))
# flextable::save_as_docx(test_dunn.media, path = "nice_table_test_dunn_media.docx")
x.subs <- test_dunn.subs$comparisons
y.subs <- test_dunn.subs$P.adjusted
...
#Grapht by treatment 
View(stat.test.subs <- substratum.inoculum.4%>% dunn_test(growth_30days ~ treatment, p.adjust.method = "bonferroni"))
...
ggboxplot(substratum.inoculum.4, x = "treatment", y = "growth_30days", fill = "treatment") +
  stat_pvalue_manual(stat.test.subs, hide.ns = TRUE)+ theme(
